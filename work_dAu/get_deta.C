...
void get_deta()
{
  ...
  TH1D* th1d_fvtxs_eta = (TH1D*)file->Get("th1d_fvtxs_eta");
  TH2D* th2d_fvtxs_eta = (TH2D*)file->Get("th2d_fvtxs_eta");
  TProfile* tp1f_detaR2 = get_profileR2(nevents,th1d_fvtxs_eta,th2d_fvtxs_eta);
...
TProfile* get_profileR2(int nevents, TH1D* th1d_1, TH1D* th1d_2, TH2D* th2d_12)
{
  ...
  TProfile *tp1f_delta_corr = new TProfile(Form("tp1f_delta_corr"), "", nbinsx+nbinsy-1, -2, 2, -1e10, 1e10,"");
  TH1D *th1d_delta_acc = new TH1D(Form("th1d_delta_acc"), "", nbinsx+nbinsy-1, -2, 2);
